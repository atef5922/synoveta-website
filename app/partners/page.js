...
const stats = [
  { value: "70+", label: "Countries", copy: "Our distribution network serves customers across 70+ countries.", icon: Globe2 },
  { value: "200+", label: "Global Partners", copy: "Trusted partners supporting customers in local markets.", icon: Users },
  { value: "10,000+", label: "Projects", copy: "Successful collaborations delivering value across industries.", icon: Building2 },
  { value: "24/7", label: "Support", copy: "Responsive technical support for our partners worldwide.", icon: Award },
];
const types = [
...
export default function PartnersPage() {
  return <><Header activePage="partners"/><main className="partners-page">
    ...
    <section className="logo-section"><div className="container"><GlobalPartnersMap/></div></section>
  </main><Footer/></>;
}
