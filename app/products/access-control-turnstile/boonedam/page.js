...
export const metadata = { title: "Boon Edam Turnstiles | Synoveta", description: "Explore Boon Edam tripod and full-height turnstile solutions." };
...
export default function BoonedamPage() {
  return <><Header activePage="products"/><main className="product-page"><div className="container">
    ...
    <div className="turnstile-heading"><p className="eyebrow">Boon Edam entrance control</p><h1>Turnstiles</h1><p className="lead">Choose the Boon Edam turnstile range that best matches your site and security requirements.</p></div>
